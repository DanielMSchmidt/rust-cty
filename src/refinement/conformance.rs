...
//
// Upstream TestValueRefine is a single table covering several concepts at once.
...
mod value_refine {
    ...
    // TestValueRefine, string refinements:
    // https://github.com/zclconf/go-cty/blob/a918e1174fcf2a25b7a222e7e78b00ea40ace26c/cty/unknown_refinement_test.go#L9
    #[test]
    #[ignore = "not yet implemented"]
    ...
    // TestValueRefine, number refinements:
    // https://github.com/zclconf/go-cty/blob/a918e1174fcf2a25b7a222e7e78b00ea40ace26c/cty/unknown_refinement_test.go#L9
    #[test]
    #[ignore = "not yet implemented"]
    fn number_refinements() {
        let tests: Vec<Case> = vec![
            // Number refinements
            (
    ...
    // TestValueRefine, list length refinements:
    // https://github.com/zclconf/go-cty/blob/a918e1174fcf2a25b7a222e7e78b00ea40ace26c/cty/unknown_refinement_test.go#L9
    #[test]
    #[ignore = "not yet implemented"]
    fn list_length_refinements() {
        let tests: Vec<Case> = vec![
            ...
            (
                ...
                Expect::Panic(
                    "refining collection of length cty.NumberIntVal(0) with lower bound 1",
                ),
            ),
        ];
    ...
    // TestValueRefine, map length refinements:
    // https://github.com/zclconf/go-cty/blob/a918e1174fcf2a25b7a222e7e78b00ea40ace26c/cty/unknown_refinement_test.go#L9
    #[test]
    #[ignore = "not yet implemented"]
    fn map_length_refinements() {
        let tests: Vec<Case> = vec![
    ...
    // TestValueRefine, set length refinements:
    // https://github.com/zclconf/go-cty/blob/a918e1174fcf2a25b7a222e7e78b00ea40ace26c/cty/unknown_refinement_test.go#L9
    #[test]
    #[ignore = "not yet implemented"]
    fn set_length_refinements() {
        let tests: Vec<Case> = vec![
