...
use crate::capsule::{CapsuleConversionFromFn, CapsuleConversionToFn};
use crate::convert::{self, internals};
use crate::{CapsuleOps, Path, Type, Value};
...
//
// Upstream TestCompareTypes is a single table covering several concepts at once.
...
mod compare_types {
    ...
    fn check(tests: &[(Type, Type, Ordering)]) {
    ...
    // TestCompareTypes, lists and sets:
    // https://github.com/zclconf/go-cty/blob/a918e1174fcf2a25b7a222e7e78b00ea40ace26c/cty/convert/compare_types_test.go#L10
    #[test]
    #[ignore = "not yet implemented"]
    fn lists_and_sets() {
