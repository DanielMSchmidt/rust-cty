...
use crate::function::{Function, ImplFunc, Parameter, Spec, TypeFunc, static_return_type};
use crate::{CtyError, Type, Value, ValueMarks};
...
fn unpredictable() {
    ...
    let uf = crate::function::unpredictable(f.clone());
